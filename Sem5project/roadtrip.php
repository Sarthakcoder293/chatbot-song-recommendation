...
<body>
    ...
    <aside>
    	...
    	<div id="similar-artist">
    		...
    		<div id="song-details">
    			<a style="padding:20px;font-size:30px;" href="party.php">Party</a>
    			<br/>
    	...
    	<div id="similar-artist">
    		...
    		<div id="song-details">
    			<a style="padding:20px;font-size:30px;" href="electronics.php">Electronics</a>
    			<br/>
    	    </div>
...
<div class="alb">
	<?php 
	 include "db_conn.php";
	 $sql = "SELECT * FROM roadtrip ORDER BY id DESC";
